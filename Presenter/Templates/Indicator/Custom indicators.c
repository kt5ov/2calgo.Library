	...
	string GetArrowByCode(int code)
	{
		switch(code)
		{
			...
			case 158: return "\u00B7";
			case 159: return "\u2022";
			case 160: case 166: return "\u25AA";
			case 161: return "\u25CB";
			case 162: case 164: return "\u2B55";
			case 165: return "\u25CE";
			case 167: return "\u2716";
			case 168: return "\u25FB";
			case 170: return "\u2726";
			...
			case 193: return "\u1F55A";
			case 194: return "\u1F55B";
			case 195: case 197: case 215: case 219: case 223: case 231: return "\u25C0";//left
			case 196: case 198: case 224: return "\u25B6";//right
			case 213: return "\u232B";
			case 214: return "\u2326";
			case 216: return "\u27A2";
			case 220: return "\u27B2";
			case 232: return "\u2794";
			case 233: case 199: case 200: case 217: case 221: case 225: return "\u25B2";//up
			case 234: case 201: case 202: case 218: case 222: case 226: return "\u25BC";//down
			case 239: return "\u21E6";
			case 240: return "\u21E8";
			case 241: return "\u21E7";
			case 242: return "\u21E9";
			case 243: return "\u2B04";
			case 244: return "\u21F3";
			case 245: case 227: case 235: return "\u2B00";//nw
			case 246: case 228: case 236: return "\u2B01";//ne
			case 247: case 229: case 237: return "\u2B03";//sw
			case 248: case 230: case 238: return "\u2B02";//se
			case 249: return "\u25AD";
			case 250: return "\u25AB";
			case 251: return "\u2717";
			case 252: return "\u2713";
